...
function SortableComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragover", function SortableComponent_div_1_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r64); const ctx_r63 = ɵngcc0.ɵɵnextContext(); return ctx_r63.onItemDragover($event, 0); })("dragenter", function SortableComponent_div_1_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r64); const ctx_r65 = ɵngcc0.ɵɵnextContext(); return ctx_r65.cancelEvent($event); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r59 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r59.placeholderClass)("ngStyle", ctx_r59.placeholderStyle);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r59.placeholderItem);
} }
...
function SortableComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragstart", function SortableComponent_div_2_Template_div_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r70); const item_r66 = ctx.$implicit; const i_r67 = ctx.index; const ctx_r69 = ɵngcc0.ɵɵnextContext(); return ctx_r69.onItemDragstart($event, item_r66, i_r67); })("dragend", function SortableComponent_div_2_Template_div_dragend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r70); const ctx_r71 = ɵngcc0.ɵɵnextContext(); return ctx_r71.resetActiveItem($event); })("dragover", function SortableComponent_div_2_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r70); const i_r67 = ctx.index; const ctx_r72 = ɵngcc0.ɵɵnextContext(); return ctx_r72.onItemDragover($event, i_r67); })("dragenter", function SortableComponent_div_2_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r70); const ctx_r73 = ɵngcc0.ɵɵnextContext(); return ctx_r73.cancelEvent($event); });
    ...
    const _r61 = ɵngcc0.ɵɵreference(4);
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(5, _c0, ctx_r60.itemClass, i_r67 === ctx_r60.activeItem ? ctx_r60.itemActiveClass : ""))("ngStyle", ctx_r60.getItemStyle(i_r67 === ctx_r60.activeItem));
    ɵngcc0.ɵɵattribute("aria-grabbed", i_r67 === ctx_r60.activeItem);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r60.itemTemplate || _r61)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c1, item_r66, i_r67));
} }
function SortableComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    const item_r74 = ctx.item;
    ɵngcc0.ɵɵtextInterpolate(item_r74.value);
} }
