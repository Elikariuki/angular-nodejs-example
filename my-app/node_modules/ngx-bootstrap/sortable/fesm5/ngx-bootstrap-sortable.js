...
function SortableComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragover", function SortableComponent_div_1_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r33); var ctx_r32 = ɵngcc0.ɵɵnextContext(); return ctx_r32.onItemDragover($event, 0); })("dragenter", function SortableComponent_div_1_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r33); var ctx_r34 = ɵngcc0.ɵɵnextContext(); return ctx_r34.cancelEvent($event); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    var ctx_r28 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngClass", ctx_r28.placeholderClass)("ngStyle", ctx_r28.placeholderStyle);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate(ctx_r28.placeholderItem);
} }
...
function SortableComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("dragstart", function SortableComponent_div_2_Template_div_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); var item_r35 = ctx.$implicit; var i_r36 = ctx.index; var ctx_r38 = ɵngcc0.ɵɵnextContext(); return ctx_r38.onItemDragstart($event, item_r35, i_r36); })("dragend", function SortableComponent_div_2_Template_div_dragend_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); var ctx_r40 = ɵngcc0.ɵɵnextContext(); return ctx_r40.resetActiveItem($event); })("dragover", function SortableComponent_div_2_Template_div_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); var i_r36 = ctx.index; var ctx_r41 = ɵngcc0.ɵɵnextContext(); return ctx_r41.onItemDragover($event, i_r36); })("dragenter", function SortableComponent_div_2_Template_div_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r39); var ctx_r42 = ɵngcc0.ɵɵnextContext(); return ctx_r42.cancelEvent($event); });
    ...
    ɵngcc0.ɵɵproperty("ngClass", ɵngcc0.ɵɵpureFunction2(5, _c0, ctx_r29.itemClass, i_r36 === ctx_r29.activeItem ? ctx_r29.itemActiveClass : ""))("ngStyle", ctx_r29.getItemStyle(i_r36 === ctx_r29.activeItem));
    ɵngcc0.ɵɵattribute("aria-grabbed", i_r36 === ctx_r29.activeItem);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r29.itemTemplate || _r30)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(8, _c1, item_r35, i_r36));
} }
function SortableComponent_ng_template_3_Template(rf, ctx) { if (rf & 1) {
    ɵngcc0.ɵɵtext(0);
} if (rf & 2) {
    var item_r43 = ctx.item;
    ɵngcc0.ɵɵtextInterpolate(item_r43.value);
} }
